...
class ArticlespiderSpider(scrapy.Spider):
    # name the crawler
    name = "vicebidenspider"
    allowed_domains = ["www.presidency.ucsb.edu"]
    # set the start url
    start_urls = ["https://www.presidency.ucsb.edu/advanced-search?field-keywords=China&field-keywords2=&field-keywords3=&from%5Bdate%5D=&to%5Bdate%5D=01-01-2018&person2=200320&items_per_page=25"]
